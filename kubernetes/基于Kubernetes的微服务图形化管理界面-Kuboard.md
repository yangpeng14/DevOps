...
Kuboard 官网地址：https://kuboard.cn/#from_coder_toutiao

`Kuboard` 在 `github` 已获得 `1867 star`，获得了许多用户的喜爱。

![image-20191217133227879](/img/image-20191217133227879.png)
...
1. 集群概览层
   ...
   ![kuboard_demo](/img/kuboard.demo.eip.work.png)
...
2. 名称空间层
   ...
   ![Kubernetes 教程](/img/image-20191002073210761.png)
...
3. 工作负载层
   ...
   ![Kubernetes 教程](/img/image-20191002073245932.png)
...
> https://kuboard.cn/#from_coder_toutiao